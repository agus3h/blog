...
<head>
  ...
  <link href="{{asset('public/vendor/datatables/jquery.dataTables.min.css')}}" rel="stylesheet">
    ...
    <link href="{{asset('public/content.css')}}" rel="stylesheet">
      <link href="{{asset('public/editor.css')}}" rel="stylesheet">
...
<body id="page-top">
  ...
  <!-- CKeditor-->
  <script src="{{asset('public/style.js')}}"></script>
  <script src="{{asset('public/ckeditor.js')}}"></script>
  <script src="{{asset('public/config.js')}}"></script>
